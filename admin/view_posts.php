...
<section class="show-posts">
   ...
   <div class="box-container">
      ...
      <form method="post" class="box">
         ...
         <a href="read_post.php?post_id=<?= $post_id; ?>" class="btn">View question</a>
      </form>
      <?php
            }
         }else{
            echo '<p class="empty">No questions added yet! <a href="add_posts.php" class="btn" style="margin-top:1.5rem;">Add question</a></p>';
         }
      ?>
