...
<?php include '../components/upvote_comment.php'>
<section class="read-post">
   ...
   <form method="post">
      ...
      <div class="icons">
         <div class="likes"><i class="fas fa-bookmark"></i><span><?= $total_post_likes; ?></span></div>
   ...
   <?php
         ...
         echo '<p class="empty">No questions added yet! <a href="add_posts.php" class="btn" style="margin-top:1.5rem;">add post</a></p>';
      }
   ?>
...
<section class="comments" style="padding-top: 0;">
   ...
   <?php
         ...
         if($select_comments->rowCount() > 0){
            while($fetch_comments = $select_comments->fetch(PDO::FETCH_ASSOC)){
               ...
               $confirm_upvote = $conn->prepare("SELECT * FROM  `upvotes` WHERE  comment_id=? ");
               $confirm_upvote->execute([$post_id]);
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <!-- <button type = "submit" name="reply_comment" class="inline-btn">Reply</button> -->
      </form>
   </div>
   <?php
         }
