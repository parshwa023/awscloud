...
<section class="home-grid">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Questions bookmarked : <span><?= $total_user_likes; ?></span></p>
         <a href="update.php" class="btn">update profile</a>
         <div class="flex-btn">
            <a href="bookmarks.php" class="option-btn">Bookmarks</a>
      ...
      <div class="box">
         ...
         <a href="category.php?category=Android development" class = "links">Android development</a>
         <a href="category.php?category=Database" class = "links">Database</a>
         <a href="category.php?category=Git hub" class = "links">Git hub</a>
         <a href="category.php?category=Academics" class = "links">Academics</a>
      ...
      <div class="box">
         ...
         ?>
            ...
            echo '<p class="empty">No questions posted yet!</p>';
         }
         ?>  
...
<section class="posts-container">
   ...
   <h1 class="heading">Latest Questions</h1>

   <div class="box-container">

      <?php
         $select_posts = $conn->prepare("SELECT * FROM `posts` WHERE status = ? ORDER BY id DESC LIMIT 6 ");
      ...
      <form class="box" method="post">
         ...
         <div class="icons">
            ...
            <button type="submit" name="like_post"><i class="fa-solid fa-bookmark" style="<?php if($confirm_likes->rowCount() > 0){ echo 'color:var(--red);'; } ?>  "></i><span>(<?= $total_post_likes; ?>)</span></button>
         </div>
   ...
   <div class="more-btn" style="text-align: center; margin-top:1rem;">
      <a href="posts.php" class="inline-btn">View all questions</a>
   </div>
