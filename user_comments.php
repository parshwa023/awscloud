...
if(isset($_POST['delete_comment'])){
   ...
   $delete_upvotes = $conn->prepare("DELETE FROM  `upvotes` WHERE comment_id = ?");
   $delete_upvotes->execute([$delete_comment_id]);
   $delete_downvotes = $conn->prepare("DELETE FROM  `downvotes` WHERE comment_id = ?");
   $delete_downvotes->execute([$delete_comment_id]);
   $delete_leaderboard_votes = $conn->prepare("DELETE FROM  `leaderboard` WHERE comment_id = ?");
   $delete_leaderboard_votes->execute([$delete_comment_id]);
